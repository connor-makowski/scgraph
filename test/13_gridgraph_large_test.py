...
print(f"{x_size}x{y_size} Graph Creation Time: ", graph_creation_time*1000, "ms")
...
if cached_output_time > 0.005:
    success = False
if hard_round(4, dijkstra_output['length']) != hard_round(4, a_star_output['length']):
    success = False
if hard_round(4, a_star_output['length']) != hard_round(4, cached_output['length']):
    success = False
