...
world_highways_and_marent_geograph = GeoGraph.load("world_highways_and_marent")
...
validate(
    ...
    realized=world_highways_and_marent_geograph.validate(
...
validate(
    ...
    realized=world_highways_and_marent_geograph.validate_nodes(),
    expected=None,
)

validate(
    name="Dijkstra",
    realized=world_highways_and_marent_geograph.get_shortest_path(
...
validate(
    ...
    realized=world_highways_and_marent_geograph.get_shortest_path(
        ...
        destination_node=destination_node,
        algorithm_fn="a_star",
        algorithm_kwargs={"heuristic_fn": world_highways_and_marent_geograph.haversine},
    ),
    expected=expected,
)
...
validate(
    ...
    realized=world_highways_and_marent_geograph.get_shortest_path(
        ...
        destination_node=destination_node,
        algorithm_fn="a_star",
        algorithm_kwargs={"heuristic_fn": world_highways_and_marent_geograph.cheap_ruler},
    ),
    expected=expected,
)
...
time_test(
    "Graph Validation",
    world_highways_and_marent_geograph.validate,
    kwargs={"check_symmetry": True, "check_connected": False},
)
time_test("Node Validation", world_highways_and_marent_geograph.validate_nodes)
...
def dijkstra():
    world_highways_and_marent_geograph.get_shortest_path(
        origin_node=origin_node,
        destination_node=destination_node,
        algorithm_fn="dijkstra",
    )
